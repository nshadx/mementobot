...
internal class FavoritesPickingStateMachine : StateMachine<FavoritesPickingState>
{
    ...
    public FavoritesPickingStateMachine()
    {
        ...
        Initially(
            When(Initial.Enter)
                .Then(async (BehaviorContext<FavoritesPickingState> context, QuizService quizService, UserService userService, QuizListMessage quizList) =>
                {
        ...
        During(QuizPicking,
            When(PageForwardEvent)
                .Then(async (BehaviorContext<FavoritesPickingState> context, QuizListMessage quizList) =>
                {
    ...
    private static async Task RenderPage(BehaviorContext<FavoritesPickingState> context, int page, QuizListMessage quizList)
    {
